...
| ⬜ todo | `deadline-priority-auto-escalation` | backend-engineer | Add automatic deadline priority escalation logic that increases urgency level as due date approaches (e.g., high→critical 24hrs before) to ensure timely reminders. |
