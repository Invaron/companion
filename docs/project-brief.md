...
| ✅ done | `biometric-authentication` | frontend-engineer | Add Web Authentication API integration for Face ID/Touch ID login on iPhone to reduce friction on app reopens and protect sensitive journal data. |
